...
from config import COLOR_SEGUNDO
...
class FormularioSitioConstruccionDesign():
    ...
    def __init__(self, panel_principal, logo):
        ...
        self.labelTitulo.config(fg="#222d33", font=("Roboto", 30), bg=COLOR_SEGUNDO)
        ...
        self.label_imagen.config(fg="#fff", font=("Roboto", 10), bg=COLOR_SEGUNDO)
